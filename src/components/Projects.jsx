...
const Projects = () => {
    ...
    const prevProject = () => {
        setCurrIndex((prevIndex) => prevIndex === 0 ? projectsData.length - 1 : prevIndex - 1)
    ...
    return (
        ...
        viewport={{ once: true }}
         className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
            <h1 className='text-2xl sm:text-4xl md:text-5xl font-bold mb-2 text-center'>Projects <span className='underline underline-offset-4 decoration-1 under font-light'>Completed</span></h1>
            ...
            <div className='overflow-hidden'>
                <div className='flex gap-8 transition-transform duration-500 ease-in-out' style={{ transform: `translateX(-${(currIndex * 100) / cardShow}%)` }}>
