...
const Testimonials = () => {
    return (
        ...
        className='container mx-auto py-10 lg:px-32 w-full' id='Testimonials'>
            <h1 className='text-2xl sm:text-4xl md:text-5xl font-bold mb-2 text-center' >Customer <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonials</span></h1>
